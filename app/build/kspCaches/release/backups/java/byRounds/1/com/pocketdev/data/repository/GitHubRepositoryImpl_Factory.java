...
public final class GitHubRepositoryImpl_Factory implements Factory<GitHubRepositoryImpl> {
  ...
  public GitHubRepositoryImpl get() {
    return newInstance(gitHubApiProvider.get(), userSettingsDataStoreProvider.get(), tokenProvider.get());
  }

  public static GitHubRepositoryImpl_Factory create(Provider<GitHubApi> gitHubApiProvider,
      Provider<UserSettingsDataStore> userSettingsDataStoreProvider,
      Provider<Function0<String>> tokenProvider) {
    return new GitHubRepositoryImpl_Factory(gitHubApiProvider, userSettingsDataStoreProvider, tokenProvider);
  }
  ...
  public static GitHubRepositoryImpl newInstance(GitHubApi gitHubApi,
    ...
    return new GitHubRepositoryImpl(gitHubApi, userSettingsDataStore, tokenProvider);
  }
}
