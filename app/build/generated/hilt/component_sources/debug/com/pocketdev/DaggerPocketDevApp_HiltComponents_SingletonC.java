...
import com.pocketdev.ui.screens.splash.SplashViewModel;
import com.pocketdev.ui.screens.splash.SplashViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerPocketDevApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends PocketDevApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(12).add(BuildViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ChatViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(CollaborationViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(EditorViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(OllamaViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(PcConnectionViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(RemoteEditorViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(RepoDetailViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ReposViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SettingsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SplashViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(TerminalViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 10: // com.pocketdev.ui.screens.splash.SplashViewModel 
          return (T) new SplashViewModel(singletonCImpl.userSettingsRepositoryImplProvider.get());

          case 11: // com.pocketdev.ui.screens.terminal.TerminalViewModel 
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new CollaborationRepositoryImpl(singletonCImpl.collaborationWebSocketProvider.get(), singletonCImpl.userSettingsRepositoryImplProvider.get());
